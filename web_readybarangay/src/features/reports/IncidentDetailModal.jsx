...
import { updateReportStatus, assignResponder, getUsers } from "../../shared/api/api";
...
// ---- main component ----
export default function IncidentDetailModal({ incident, onClose, onRefresh, canManage = true }) {
                        ...
                        {isManaging ? (
                            <>
                                ...
                                <button
                                    ...
                                    onMouseEnter={e => { if (!isSaving) { e.currentTarget.style.transform = "translateY(-1px)"; e.currentTarget.style.boxShadow = "0 4px 14px rgba(220,38,38,0.4)"; } }}
                                    onMouseLeave={e => { if (!isSaving) { e.currentTarget.style.transform = "none"; e.currentTarget.style.boxShadow = "0 2px 8px rgba(220,38,38,0.3)"; } }}
                                >
