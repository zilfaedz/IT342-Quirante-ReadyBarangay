...
// Captain Budget & Resources
export const getResourceDashboard = () => api.get('/resources').then(res => res.data);
export const createBudgetLine = (data) => api.post('/resources/budget-lines', data).then(res => res.data);
export const updateBudgetLine = (id, data) => api.put(`/resources/budget-lines/${id}`, data).then(res => res.data);
export const createResourceItem = (data) => api.post('/resources/items', data).then(res => res.data);
export const updateResourceItem = (id, data) => api.put(`/resources/items/${id}`, data).then(res => res.data);
export const createPurchaseRequest = (data) => api.post('/resources/purchase-requests', data).then(res => res.data);
export const updatePurchaseRequest = (id, data) => api.put(`/resources/purchase-requests/${id}`, data).then(res => res.data);
